...
def find_mean_and_SD_fourValues(f3, QueueType, RTT, Metric):
    ...
    filename = "./HeteroResults/Statistics/" + QueueType + "_Mean_" + Metric + ".txt" 
    M = open(filename, "a")
    filename = "./HeteroResults/Statistics/" + QueueType + "_SD_" + Metric + ".txt" 
    SD = open(filename, "a")
...
for i in queue_size:
    for j in round_trip_time:
        if(i=="Threshold100" or i=="Threshold15"):
            f1 = "./HeteroResults/" + i + "/" + i + str(j) + "msRTTth.txt"
            f2 = "./HeteroResults/" + i + "/" + i + str(j) + "msRTTU.txt"
            f3 = "./HeteroResults/" + i + "/" + i + str(j) + "msRTTQS.txt"
            f4 = "./HeteroResults/" + i + "/" + i + str(j) + "msRTTLoss.txt"
        else: 
            f1 = "./HeteroResults/" + i + "/" + i + str(j) + "RTTth.txt"
            f2 = "./HeteroResults/" + i + "/" + i + str(j) + "RTTU.txt"
            f3 = "./HeteroResults/" + i + "/" + i + str(j) + "RTTQS.txt"
            f4 = "./HeteroResults/" + i + "/" + i + str(j) + "RTTLoss.txt"
